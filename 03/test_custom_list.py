...
def compare_clist_list(l1: list, l2: CustomList):
    for elem_list, elem_clist in zip(l1, l2):
        if elem_list != elem_clist:
            return False
    return True
...
class CustomListTests(TestCase):
    ...
    def test_init(self):
        ...
        self.assertEqual(True, compare_clist_list([2, 3, 4, 5], clist))
    ...
    def test_add_only_custom_lists(self):
        ...
        self.assertEqual(True, compare_clist_list([1, 2, 3], res_1))
        self.assertEqual(True, compare_clist_list([1, 2, 3], clist_3))
        self.assertEqual(True, compare_clist_list([], clist_0))

        res_2 = clist_0 + clist_3

        self.assertEqual(CustomList, type(res_2))
        self.assertEqual(True, compare_clist_list([1, 2, 3], res_2))
        self.assertEqual(True, compare_clist_list([1, 2, 3], clist_3))
        self.assertEqual(True, compare_clist_list([], clist_0))
        ...
        self.assertEqual(True, compare_clist_list([4, 4, 4], res_3))
        self.assertEqual(True, compare_clist_list([1, 2, 3], clist_3))
        self.assertEqual(True, compare_clist_list([3, 2, 1], clist_3_1))
    ...
    def test_radd_custom_list_and_list(self):
        ...
        self.assertEqual(CustomList, type(res_2))
        self.assertEqual(True, compare_clist_list([2, 4, 6, 4, 5], res_2))
        self.assertEqual(True, compare_clist_list([1, 2, 3], clist_3))
        ...
        self.assertEqual(CustomList, type(res_3))
        self.assertEqual(True, compare_clist_list([4, 6, 8], res_3))
        self.assertEqual(True, compare_clist_list([1, 2, 3], clist_3))
    ...
    def test_add_custom_list_and_list(self):
        ...
        self.assertEqual(CustomList, type(res_3))
        self.assertEqual(True, compare_clist_list([2, 4, 8], res_3))
        self.assertEqual(True, compare_clist_list([1, 2, 3], clist_3))
    ...
    def test_sub_only_custom_lists(self):
        ...
        self.assertEqual(CustomList, type(res_1))
        self.assertEqual(True, compare_clist_list([-2, -2, -2, 4, 5], res_1))
        self.assertEqual(True, compare_clist_list([3, 4, 5], clist_3))
        self.assertEqual(True, compare_clist_list([1, 2, 3, 4, 5], clist_5))

        res_2 = clist_3 - clist_5

        self.assertEqual(CustomList, type(res_2))
        self.assertEqual(True, compare_clist_list([2, 2, 2, -4, -5], res_2))
        self.assertEqual(True, compare_clist_list([3, 4, 5], clist_3))
        self.assertEqual(True, compare_clist_list([1, 2, 3, 4, 5], clist_5))
        ...
        self.assertEqual(CustomList, type(res_3))
        self.assertEqual(True, compare_clist_list([2, 2, 2], res_3))
        self.assertEqual(True, compare_clist_list([3, 4, 5], clist_3))
        self.assertEqual(True, compare_clist_list([1, 2, 3], clist_3_1))
    ...
    def test_sub_custom_list_and_list(self):
        ...
        self.assertEqual(CustomList, type(res_1))
        self.assertEqual(True, compare_clist_list([-1, -1, -1, 4, 5], res_1))
        ...
        self.assertEqual(CustomList, type(res_2))
        self.assertEqual(True, compare_clist_list([-2, -1, 0, 3, 3, -3], res_2))
        self.assertEqual([3, 3, 3, 1, 2, 3], list_6)
        self.assertEqual(True, compare_clist_list([1, 2, 3, 4, 5], clist_5))

        list_5 = [5, 4, 3, 2, 1]
        res_3 = clist_5 - list_5

        self.assertEqual(CustomList, type(res_3))
        self.assertEqual(True, compare_clist_list([-4, -2, 0, 2, 4], res_3))
    ...
    def test_rsub_custom_list_and_list(self):
        ...
        self.assertEqual(CustomList, type(res_3))
        self.assertEqual(True, compare_clist_list([7, 5, 3, 1, -1], res_3))
